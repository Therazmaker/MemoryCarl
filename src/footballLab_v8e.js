            ...
            <div class="b2-card">
              <div class="b2-card-body b2-topbar-kpis">
                <div>
                  ...
                  <div class="b2-kpi-value">${health.teamsLearned}</div>
                </div>
                <div>
                  <div class="b2-kpi-label">Matches learned</div>
                  <div class="b2-kpi-value">${health.matchesLearned}</div>
                </div>
                <div>
                  <div class="b2-kpi-label">Confianza</div>
                  <div class="b2-kpi-value">${(health.confidence * 100).toFixed(0)}%</div>
                </div>
                <div>
