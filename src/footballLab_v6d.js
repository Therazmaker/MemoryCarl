...
export function initFootballLab(){
  ...
  if(moreBtn){
    ...
    labBtn.innerText = "⚽ Football Lab (V6)";
  ...
  function renderPlayer(db, playerId){
    ...
    const logs = db.matches
      .filter(m=>m.playerId===playerId && m.season===season)
      ...
      <div class="fl-card">
        <div style="display:flex;justify-content:space-between;gap:10px;align-items:center;">
          <div>
            ...
            <div class="fl-small">${escapeHtml(team?.name||"Sin equipo")} • <b>${escapeHtml(POS_LABELS[p.position]||p.position)}</b> • Temporada: <b>${escapeHtml(season)}</b></div>
          </div>
          <div style="display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end;">
      ...
      <div class="fl-grid2">
        ...
        <div class="fl-card">
          ...
          <div class="fl-small" style="margin-top:8px;">
            ...
            Acciones defensivas: <b>${agg.defActions}</b>
          </div>
          <div class="fl-small" style="margin-top:10px;">
          ...
          <div class="fl-grid2" style="margin-top:10px;">
            <div class="fl-card" style="margin:0;">
              ...
              <div class="fl-row" style="margin-top:8px;">
                ...
                <input class="fl-input" id="pl_losses" type="number" min="0" step="1" placeholder="Pérdidas">
              </div>
              <div class="fl-row" style="margin-top:8px;">
            ...
            <div class="fl-card" style="margin:0;">
              ...
              <div class="fl-row" style="margin-top:8px;">
                <input class="fl-input" id="pl_cleanSheet" type="number" min="0" max="1" step="1" placeholder="Clean sheet 0/1">
              </div>
            </div>
          </div>
        </details>
